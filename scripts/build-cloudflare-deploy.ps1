...
$publicFiles = @('index.html', 'install.html', 'manifest.json', 'yc-console-8k3n7q.html', 'admin-manifest.json', 'robots.txt', 'sitemap.xml', '1e2cd6976b8c425298b0f3a0d66e3440.txt')
